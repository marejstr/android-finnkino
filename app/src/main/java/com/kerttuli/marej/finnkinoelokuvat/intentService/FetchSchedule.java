...
import com.kerttuli.marej.finnkinoelokuvat.MainActivity;
...
/**
 * Created by martin on 12/18/16.
 */

public class FetchSchedule extends FetchTemplate{

    private String mUrl;
    private Context mContext;

    public FetchSchedule(String url, Context context) {
    ...
    LinkedList<ContentValues> parseXML(XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        //TODO remove
        //Log.e("event type", String.valueOf(eventType));
        ...
        while (eventType != XmlPullParser.END_DOCUMENT) {
            ...
            switch (eventType) {
                ...
                case XmlPullParser.END_TAG:
                    if (name.equals("Show")) {
/*
                        //TODO implement with interface
                        Log.e("title", title);
                        if (title.equals("")) {
                            Log.e("empty title", "");
                            ((MainActivity) mContext).noScheduleData();
                        }
                        */
        ...
        //TODO remove
        Log.e("contentlist length", String.valueOf(contentValuesList.size()));
